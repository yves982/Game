 ...
 * An World Generator
 * <p>
 * It divides the world into rows ({@link Range} of y coordinates), for positioning ease<br>
 * And it places {@link Area Areas}, {@link Obstacle Obstacles} and the {@link Player} within the {@link World}
 * </p>.
 */
public class WorldGenerator {
	 ...
	 */
	private Player generatePlayer(int maxLives, int maxLeftTimeMs, int row, int movesStep, Range<Integer> xBounds, Range<Integer> yBounds) {
	...
	/**
	 * generate an Obstacle of a given kind in a specified row after a given space with the previous Obstacle.
	 *
	 ...
	 */
	private Obstacle generateObstacle(ObstacleKind kind, int row, int spaceAfterPrevious) {
		Range<Integer> xBounds = new Range<Integer>(0, world.getWidth());
	...
	/**
	 * Checks if this WorldGenerator has already spawned World once or not.
	 *
	 * @return true if a first generation happened before, false otherwise
	 */
