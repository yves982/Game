...
/**
 * interface for a view with a fr.cesi.ylalanne.main component to be added to some parent view.<br>
...
public interface IChildView extends IView {
	/**
	 * get the fr.cesi.ylalanne.main component of this childView
	 * <p>
	 ...
	 * </p>
	 * @return the view's fr.cesi.ylalanne.main component to display in a parent view
